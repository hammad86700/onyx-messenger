      ...
      <div className="p-3.5 rounded-2xl bg-slate-900/70 border border-white/10 shadow-xl backdrop-blur-xl relative overflow-hidden">
        ...
        {onEditProfile && (
          <button
            ...
            className="w-full mt-3 py-2 px-3 rounded-xl bg-white/5 hover:bg-white/10 text-xs font-semibold text-white border border-white/10 transition-colors flex items-center justify-center gap-1.5 touch-manipulation"
          >
